...
Project to initiate tool calling without using Langchain to manually handle JSON parsing, 
manage the full reasoning and action loop, format tool inputs and outputs.
"""
...
price_function = {
    ...
    "description": "Get the price of a ticket to a concert host at the destination city.",
    "parameters": {
        "type": "object",
        "properties": {
...
book_function = {
    "name": "book_tickets",
    "description": "Book tickets for a specific destination and number of headcount.",
    "parameters": {
        "type": "object",
        "properties": {
...
# ==============================================
# 4. when LLM respond to the user request and contains "tool_calls", then it will invoke this fn to call the respective function to perform the action
# and structured into a json format for LLM to parse the 2nd time
# ==============================================
...
# ==============================================
# 5. The chat fn to invoke by Gradio to allow me to communicate with LLM and perform tool calling
# ==============================================
def chat(message, history,
    ...
    print("Initial reply:", completion.choices[0].message.content)
...
gr.ChatInterface(
    fn=chat,
    type="messages",
    title="AITICKETS Customer Support",
    description="Ask about concerts, ticket prices, or book tickets in a friendly baby-blue chat window",
    theme="soft",
    css=custom_css,
